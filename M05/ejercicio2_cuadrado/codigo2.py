...
if es_cuadrado_perfecto(num_usuario):
    ...
    print("El numero" , num_usuario, "no es un cuadrado perfecto")
'''
...
# El unico error encontrado fue el nombre de la variable a evaluar en el IF ya que este decia "test_values"